...
const buttonVariants = cva(
  ...
  focus-visible:ring-zinc-950 disabled:cursor-not-allowed disabled:opacity-50 dark:focus-visible:ring-zinc-300`,
  {
    variants: {
      variant: {
        default:
        ...
        outline: `border border-zinc-200 bg-white shadow-sm hover:bg-zinc-100
          hover:text-zinc-900 dark:border-zinc-800 dark:bg-zinc-950 dark:hover:bg-zinc-800 dark:hover:text-zinc-50`,
        secondary:
